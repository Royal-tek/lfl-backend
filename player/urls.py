...
from .views import PlayerListView, PlayerCreate,ListAllCoaches, PointListView, AwardPoint, CreateTeam, News, LoggedUser, ListAllPlayers, CoachPlayers, DisplayAllPlayers
